...
def _patch_hsprotect_js_source(url: str, source: str) -> tuple[str, list[str]]:
    ...
    if "captcha.hsprotect.net/" in url and "captcha.js" in url:
        ...
        if wasm_import_wrap_needle in patched:
            wasm_import_wrap_replacement = (
                "n[r(v(1021,1079))][v(1123,1104)]=function(){var r,n;return M(c[u((r=-447,n=-366,v(r,n- -1450)))])},"
                "function(){try{var __imp=n,__groups=Object.keys(__imp),__count=0;for(var __gi=0;__gi<__groups.length;__gi++){var __grp=__groups[__gi],__obj=__imp[__grp];if(!__obj||!Object.keys)continue;var __names=Object.keys(__obj);for(var __ni=0;__ni<__names.length;__ni++){(function(__grp,__name){var __fn=__obj[__name];if(typeof __fn!==\"function\"||__fn.__outlookWasmImportWrapped)return;var __orig=__fn,__wrap=function(){var __root=(typeof globalThis!==\"undefined\"?globalThis:(typeof self!==\"undefined\"?self:window)),__active=__root&&__root.__outlookHsprotectWasmActive,__args=[];if(__active){try{for(var __ai=0;__ai<arguments.length;__ai++){var __av=arguments[__ai];__args.push(typeof __av===\"number\"?__av:String(__av).slice(0,96))}__outlookPatchEmit('hsprotect.captcha.wasm.import.call',{active:__active,group:String(__grp),name:String(__name),argc:arguments.length,args:__args,stack:(new Error).stack})}catch(_){}}var __ret,__threw=0,__err;try{__ret=__orig.apply(this,arguments);return __ret}catch(__e){__threw=1;__err=__e;throw __e}finally{if(__active){try{var __detail={active:__active,group:String(__grp),name:String(__name),threw:!!__threw,retType:typeof __ret,ret:String(__ret).slice(0,96)};if((__name==='__wbg_getRandomValues_37fa2ca9e4e07fab'||__name==='__wbg_randomFillSync_dc1e9a60c158336d')&&arguments.length>=2){try{var __arr=(__name==='__wbg_randomFillSync_dc1e9a60c158336d'?g(arguments[1]):w(arguments[1]));if(__arr&&typeof __arr.length==='number'){var __rb=[],__rh='',__rlen=__arr.length>>>0;for(var __ri=0;__ri<__rlen;__ri++){var __rv=__arr[__ri]&255;__rb.push(__rv);__rh+=('0'+__rv.toString(16)).slice(-2)}__detail.randomLen=__rlen;__detail.randomBytes=__rb;__detail.randomHex=__rh}}catch(__randomErr){__detail.randomCaptureError=String(__randomErr&&(__randomErr.stack||__randomErr.message)||__randomErr).slice(0,160)}}if(__name==='__wbg_get_e6ae480a4b8df368'&&arguments.length>=3){try{__detail.prop=y(arguments[1],arguments[2])}catch(_){}}if(__name==='__wbindgen_string_get'&&arguments.length>=2){try{var __h=H(),__p=__h[arguments[0]/4+0],__l=__h[arguments[0]/4+1];__detail.outPtr=arguments[0];__detail.heapIdx=arguments[1];__detail.outStringPtr=__p;__detail.outStringLen=__l;__detail.outStringPreview=__p&&__l?y(__p,Math.min(__l,160)):''}catch(_){}}if(__threw)__detail.error=String(__err&&(__err.stack||__err.message)||__err).slice(0,160);__outlookPatchEmit('hsprotect.captcha.wasm.import.return',__detail)}catch(_){}}}};__wrap.__outlookWasmImportWrapped=1;__obj[__name]=__wrap;__count++})(__grp,__names[__ni])}}__outlookPatchEmit('hsprotect.captcha.wasm.import.wrap',{groups:__groups,functionCount:__count,stack:(new Error).stack})}catch(_){}return n}()}function b"
            )
            patched = patched.replace(wasm_import_wrap_needle, wasm_import_wrap_replacement, 1)
            patches.append(marker("captcha_wasm_import_wrap"))
        wasm_bind_needle = "function b(r,n){var t,v;return c=r[u(\"Mk4JHxwcJw\")],h[(t=128,v=62,i(t,v- -1044))]=n,l=null,L=null,c}"
        if wasm_bind_needle in patched:
            patched = patched.replace(
                wasm_bind_needle,
                "function b(r,n){var t,v;try{var __exp=r[u(\"Mk4JHxwcJw\")];__outlookPatchEmit('hsprotect.captcha.wasm.bind',{exportsKey:String(u(\"Mk4JHxwcJw\")),exportKeys:__exp&&Object.keys?Object.keys(__exp):[],ngExport:String(u(\"Ng\")),nqExport:String(u(\"NQ\")),nqExportType:typeof(__exp&&__exp[u(\"NQ\")]),nqExportLen:(__exp&&__exp[u(\"NQ\")]&&__exp[u(\"NQ\")].length)||null,memoryBytes:__exp&&__exp.memory&&__exp.memory.buffer&&__exp.memory.buffer.byteLength,moduleType:typeof n,stack:(new Error).stack})}catch(_){}return c=r[u(\"Mk4JHxwcJw\")],h[(t=128,v=62,i(t,v- -1044))]=n,l=null,L=null,c}",
                1,
            )
            patches.append(marker("captcha_wasm_bind"))
        ...
        if wasm_ng_needle in patched:
            patched = patched.replace(
                wasm_ng_needle,
                "f[v(\"Ng\")]=function(){function r(r,n){return i(n,r- -1813)}var n=u;try{var t=c[r(-715,-793)](-16);try{var __root=(typeof globalThis!==\"undefined\"?globalThis:(typeof self!==\"undefined\"?self:window));__root.__outlookHsprotectWasmActive={fn:\"Ng\",stackPtr:t,stack:(new Error).stack};__outlookPatchEmit('hsprotect.captcha.wasm.ng.before',{stackPtr:t,exportName:String(n(\"Ng\")),exportType:typeof(c&&c[n(\"Ng\")]),memoryBytes:c&&c.memory&&c.memory.buffer&&c.memory.buffer.byteLength,stack:(new Error).stack})}catch(_){}try{c[n(\"Ng\")](t)}finally{try{var __root2=(typeof globalThis!==\"undefined\"?globalThis:(typeof self!==\"undefined\"?self:window));__root2.__outlookHsprotectWasmActive=null}catch(_){}}var v=H()[t/4+0],e=H()[t/4+1],f=H()[t/4+2],s=H()[t/4+3],m=v,z=e;try{__outlookPatchEmit('hsprotect.captcha.wasm.ng.after',{stackPtr:t,retPtr:v,retLen:e,errPtr:f,err:s,retPreview:v&&e?y(v,Math.min(e,160)):\"\",memoryBytes:c&&c.memory&&c.memory.buffer&&c.memory.buffer.byteLength,stack:(new Error).stack})}catch(_){}if(s)throw m=0,z=0,g(f);return y(m,z)}finally{c[r(-715,-682)](16),c.__wbindgen_free(m,z)}}",
                1,
            )
            patches.append(marker("captcha_wasm_ng_wrapper"))
        ...
        if wasm_nq_needle in patched:
            patched = patched.replace(
                wasm_nq_needle,
                "f[v(\"NQ\")]=function(r){var n=u;function t(r,n){return i(r,n- -1266)}try{var v=c.__wbindgen_add_to_stack_pointer(-16),e=a(r,c[t(-156,-130)],c[t(-33,-74)]),f=K;try{var __mem0=q(),__inBytes=[],__exportName=n(\"NQ\");for(var __bi=0;__bi<Math.min(f,96);__bi++)__inBytes.push(__mem0[e+__bi]);__outlookPatchEmit('hsprotect.captcha.wasm.nq.before',{input:String(r),inputType:typeof r,inputLen:typeof r===\"string\"?r.length:null,ptr:e,len:f,stackPtr:v,inputBytes:__inBytes,exportName:String(__exportName),exportType:typeof(c&&c[__exportName]),exportLen:(c&&c[__exportName]&&c[__exportName].length)||null,exportKeys:c&&Object.keys?Object.keys(c):[],memoryBytes:c&&c.memory&&c.memory.buffer&&c.memory.buffer.byteLength,stack:(new Error).stack})}catch(_){}try{var __root=(typeof globalThis!==\"undefined\"?globalThis:(typeof self!==\"undefined\"?self:window));__root.__outlookHsprotectWasmActive={fn:\"NQ\",input:String(r),ptr:e,len:f,stackPtr:v,stack:(new Error).stack}}catch(_){}try{c[n(\"NQ\")](v,e,f)}finally{try{var __root2=(typeof globalThis!==\"undefined\"?globalThis:(typeof self!==\"undefined\"?self:window));__root2.__outlookHsprotectWasmActive=null}catch(_){}}var s=H()[v/4+0],m=H()[v/4+1],z=H()[v/4+2],o=H()[v/4+3],w=s,L=m;try{var __mem1=q(),__retBytes=[];for(var __ri=0;__ri<Math.min(m,160);__ri++)__retBytes.push(__mem1[s+__ri]);__outlookPatchEmit('hsprotect.captcha.wasm.nq.after',{input:String(r),ptr:e,len:f,stackPtr:v,retPtr:s,retLen:m,errPtr:z,err:o,retPreview:s&&m?y(s,Math.min(m,160)):\"\",retBytes:__retBytes,memoryBytes:c&&c.memory&&c.memory.buffer&&c.memory.buffer.byteLength,stack:(new Error).stack})}catch(_){}if(o)throw w=0,L=0,g(z);return y(w,L)}finally{c[t(-226,-168)](16),c[t(47,-33)](w,L)}}",
                1,
            )
            patches.append(marker("captcha_wasm_nq_wrapper"))
