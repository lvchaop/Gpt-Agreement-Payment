...
OUT = PROTO / "goal_audit/h2_first_failure_head_delay_control_audit.json"

DIRECT = PROTO / "direct_webshare_attempt/direct_webshare_attempt_ibtvqcnm-JP-1781238017000_1781238017.json"
COMBO = PROTO / "seq5_seq6_combo_probe/seq5_seq6_combo_probe_04597aae-6616-11f1-98cd-62666cc2b93d_1781238098.json"
SEQ5_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_04597aae-6616-11f1-98cd-62666cc2b93d_1781238098_seq5_full_activity_diff.json"
SEQ5_FIELD = PROTO / "px561_compare/seq5_seq6_combo_probe_04597aae-6616-11f1-98cd-62666cc2b93d_1781238098_seq5_full_field_diff.json"
SEQ6_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_04597aae-6616-11f1-98cd-62666cc2b93d_1781238098_seq6_full_activity_diff.json"
...
def main() -> int:
    ...
    audit = {
        "purpose": "Combine s00-style first rejected PX561 history, full asset-lineage, observed captcha HEAD delay, and h2 seq5/seq6 decoded-body equality in one fresh Webshare session.",
        "inputs": {
            "direct": str(DIRECT),
            "combo": str(COMBO),
        ...
        "conclusion": (
            "Adding the observed captcha HEAD delay to the already combined first-failure-history + full-asset-lineage + h2 dual-activity control still returns oIIoIooo|-1. "
            "Thus the remaining boundary is not explained by the captcha HEAD request, its observed delay before line933, first-failure history, h2 multiplexing, or decoded seq5/seq6 body equality."
        ),
    }
