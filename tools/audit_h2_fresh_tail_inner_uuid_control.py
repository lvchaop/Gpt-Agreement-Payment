...
OUT = PROTO / "goal_audit/h2_fresh_tail_inner_uuid_control_audit.json"

DIRECT = PROTO / "direct_webshare_attempt/direct_webshare_attempt_ibtvqcnm-JP-1781239576000_1781239576.json"
COMBO = PROTO / "seq5_seq6_combo_probe/seq5_seq6_combo_probe_a574d746-6619-11f1-a5c1-62666cc2b93d_1781239656.json"
SEQ5_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_a574d746-6619-11f1-a5c1-62666cc2b93d_1781239656_seq5_full_activity_diff.json"
SEQ5_FIELD = PROTO / "px561_compare/seq5_seq6_combo_probe_a574d746-6619-11f1-a5c1-62666cc2b93d_1781239656_seq5_full_field_diff.json"
SEQ6_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_a574d746-6619-11f1-a5c1-62666cc2b93d_1781239656_seq6_full_activity_diff.json"
...
def main() -> int:
    ...
    audit = {
        "purpose": "Dual-variable control: fresh server-bound POW/WASM tail plus fresh PX561 inner uuid, while keeping accepted template stack and non-PX decoded activities.",
        "inputs": {
            "direct": str(DIRECT),
            "combo": str(COMBO),
        ...
        "checks": {
            ...
            "usesFreshTailAndFreshInnerUuid": meta.get("aeaxSource") == "offline-ng"
            ...
            "onlyTailAndInnerUuidDiffVsS00": seq5_field.get("diffCountVsS00Success") == 5
        ...
        "conclusion": (
            "Combining fresh POW/WASM tail fields with a fresh PX561 inner uuid, while preserving accepted template stack/non-PX activities and the strongest h2/asset/timing lineage, still returns oIIoIooo|-1. "
            "Therefore the remaining acceptance gap is not solved by the tail+inner-uuid pair."
        ),
    }
