...
OUT = PROTO / "goal_audit/h2_inner_uuid_binding_control_audit.json"

DIRECT = PROTO / "direct_webshare_attempt/direct_webshare_attempt_ibtvqcnm-JP-1781239057000_1781239057.json"
COMBO = PROTO / "seq5_seq6_combo_probe/seq5_seq6_combo_probe_7038e62c-6618-11f1-967a-62666cc2b93d_1781239132.json"
SEQ5_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_7038e62c-6618-11f1-967a-62666cc2b93d_1781239132_seq5_full_activity_diff.json"
SEQ5_FIELD = PROTO / "px561_compare/seq5_seq6_combo_probe_7038e62c-6618-11f1-967a-62666cc2b93d_1781239132_seq5_full_field_diff.json"
SEQ6_ACTIVITY = PROTO / "px561_compare/seq5_seq6_combo_probe_7038e62c-6618-11f1-967a-62666cc2b93d_1781239132_seq6_full_activity_diff.json"
...
def main() -> int:
    ...
    audit = {
        "purpose": "Single-variable control for PX561 inner/outer uuid binding: keep accepted template tail/stack/non-PX activities, but set PX561 inner FUFvS1Mga38= to the fresh outer uuid.",
        "inputs": {
            "direct": str(DIRECT),
            "combo": str(COMBO),
        ...
        "checks": {
            ...
            "onlyPx561InnerUuidDiffVsS00": seq5_field.get("diffCountVsS00Success") == 1
            and (seq5_field.get("diffsByClass") or {}) == {"session_or_cookie": ["FUFvS1Mga38="]},
        ...
        "conclusion": (
            "Changing only PX561 inner FUFvS1Mga38= to the fresh outer uuid, while preserving accepted template tail/stack/non-PX decoded activities and the strongest h2/asset/timing lineage, still returns oIIoIooo|-1. "
            "Therefore the remaining acceptance gap is not solved by inner/outer uuid binding alone."
        ),
    }
