...
def _parse_window(raw_window: dict[str, Any]) -> WhamUsageWindow | None:
    ...
    quota_window_kind = quota_window_kind_from_seconds(limit_window_seconds)
...
def quota_window_kind_from_seconds(limit_window_seconds: int) -> str | None:
