        ...
        *,
        ...
        return {
            ...
            "create_proxy_country": (
                us_proxy.country_code if us_proxy is not None else self._us_proxy_country
            ),
            "create_proxy_sid_source": (
                us_proxy.sid_source if us_proxy is not None else "checkout_reuse"
            ),
            "create_proxy_probe_attempts": (
                us_proxy.probe_attempts if us_proxy is not None else 0
            ),
            "subscription_sync": subscription_sync,
        }
